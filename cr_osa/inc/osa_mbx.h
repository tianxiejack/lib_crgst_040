...
int OSA_mbxSendMsg(OSA_MbxHndl *pTo, OSA_MbxHndl *pFrom, Uint32 cmd, void *pPrm, Uint32 flags);
int OSA_mbxBroadcastMsg(OSA_MbxHndl *pToList[], OSA_MbxHndl *pFrom, Uint32 cmd, void *pPrm, Uint32 flags);
